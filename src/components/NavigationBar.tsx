    ...
    <nav className="bg-white shadow-md relative z-50">
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link
                href="/"
                className={`${delaGothicOne.className} text-3xl font-bold text-blue-600`}
              >
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            {session ? (
              <div className="relative ml-3">
                ...
                {isMenuOpen && (
                  <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none dropdown-animation">
                    <Link
                      href="/account"
      ...
      {isMenuOpen && (
        <>
          ...
          {/* メニューコンテンツ */}
          <div className="sm:hidden bg-white relative z-50 overflow-hidden mobile-menu-content">
