    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white">
      ...
      <section className="relative overflow-hidden pt-20 pb-16 md:pt-32 md:pb-24">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            >
              既存の地図や画像を活かしながら、インタラクティブなパンフレットへ
            </motion.p>
          ...
          <Tabs value={activeTab} className="w-full max-w-5xl mx-auto" onValueChange={setActiveTab}>
            ...
            >
              <TabsContent value="create" className="mt-0 p-3">
                <div className="flex flex-col md:flex-row gap-8 items-center">
                  <div className="w-full md:w-1/2 relative h-[300px] md:h-[400px] rounded-lg overflow-hidden bg-sky-50">
                    <Image src="/ssss.jpeg" alt="元の地図" fill className="object-contain p-2" />
                  </div>
              ...
              <TabsContent value="edit" className="mt-0 p-3">
                <div className="flex flex-col md:flex-row gap-8 items-center">
                  <div className="w-full md:w-1/2 relative h-[300px] md:h-[400px] rounded-lg overflow-hidden bg-sky-50">
                    <Image src="/ffff.jpeg" alt="編集画面" fill className="object-contain p-2" />
                  </div>
                  <div className="w-full md:w-1/2 space-y-4 text-left">
      ...
      <section className="py-16 md:py-24 bg-sky-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center text-center mb-8">
            <AnimatedSectionTitle>様々な場面での活用</AnimatedSectionTitle>
            <AnimatedSectionDescription>
          ...
          <div ref={casesRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                title: '観光スポット',
                description:
                  '観光地や公園の案内図として。見どころや施設の情報を詳しく紹介できます。',
                icon: <Eye className="h-10 w-10 text-sky-600" />,
              },
              {
                title: 'イベント会場',
                description:
                  '展示会や見本市の会場マップとして。ブースの位置や出展者情報を簡単に確認できます。',
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <motion.h2
              ...
              transition={{ duration: 0.6, ease: 'easeOut' }}
              className="text-xl md:text-4xl font-bold tracking-tight text-slate-900"
            >
              あなたの地図をインタラクティブへ
            </motion.h2>
            <motion.p
      ...
      <footer className="py-8 bg-sky-900 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <p> Pamfree. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
